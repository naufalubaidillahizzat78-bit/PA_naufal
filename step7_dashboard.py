...
def get_cluster_characteristic(lbl):
    chars = {
        ...
        'Tinggi': "IPK kumulatif tinggi (IPK 3.3 - 3.5), kehadiran sangat baik, dan performa akademis stabil di atas rata-rata.",
...
def build_dashboard(df_labeled_path='output/df_labeled.pkl',
    ...
    for i, row in df.iterrows():
        ...
        if lbl == 'Sangat Tinggi':
            ...
            recom = "mengarahkan mahasiswa untuk bergabung dalam kelompok belajar sebaya (peer study group), menguatkan pemahaman praktis di lab, serta menjaga konsistensi nilai."
        elif lbl == 'Cukup':
            recom = "mengagendakan sesi bimbingan berkala dengan Dosen Wali untuk memantau kesulitan mata kuliah tertentu, menyarankan remedial terstruktur, dan meningkatkan partisipasi kelas."
        else:  # Rendah
